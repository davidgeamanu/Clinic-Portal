...
import com.clinic.portal.security.JpaUserDetailsService;
import com.clinic.portal.security.JwtAuthenticationFilter;
import com.clinic.portal.security.JwtService;
import com.clinic.portal.security.LoginAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        LoginAuthenticationFilter loginFilter = new LoginAuthenticationFilter(
                authenticationManager, jwtService, cookieService, objectMapper, loginUrl);
